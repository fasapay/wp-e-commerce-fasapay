...
function wpsc_transaction_theme() {
	...
	if($_GET['fpres'] == 'success'){
		include "wp-content/plugins/fasapay/help/success.php";
	}else if($_GET['fpres'] == 'fail'){
		include "wp-content/plugins/fasapay/help/fail.php";
	}else if($_GET['fpres'] == 'status'){
		include "wp-content/plugins/fasapay/help/status_wpe.php";
	}
}
